...
ENV TZ=America/Toronto FLASK_PORT=5000 PLEX_PORT=32400 CONTENT_RATING="G,PG,TV-G,TV-PG,TV-Y,ca/G,ca/PG,ca/TV-PG,ca/TV-Y7" COMMONSENSE_AGE=12 AUDIO_LANGUAGE="French,french-canadian" LANGUAGE_CODE="fra" EXCLUDED_LABLES="Enfants,ExcludeEnfants"
